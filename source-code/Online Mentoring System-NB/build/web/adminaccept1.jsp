...
<br><br>
<div align="center">
<font color="green"><h2><b><i>Mentor’s (Senior’s) Action Page</i></h2></font>
<br>
...
ResultSet rs=st.executeQuery("select * from mregister where status_r='register' ");
while(rs.next())
{%>
...
<td></td>
<td>&nbsp;&nbsp;<a href ="accept1.jsp?email=<%=rs.getString(4)%>"><font style= "color:blue">Accept  </a></font><b>/ </b>
<a href="reject1.jsp?email=<%=rs.getString(4)%>"><font style= "color:red">Reject</a></font></td>
