...
ResultSet r=st.executeQuery("select * from register where email='"+eemail+"' and pass='"+pwd+"'  ");
if(r.next())
	{
		 System.out.println("if");
Statement st3=con.createStatement();
ResultSet r3=st3.executeQuery("select * from register where email='"+eemail+"' and pass='"+pwd+"' and status_r!='register' ");
if(r3.next()){
